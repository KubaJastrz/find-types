...
export const AlertTriangle = forwardRef<SVGSVGElement, IconProps>(function AlertTriangle(
  props,
  ref,
) {
  return (
...
export const Bitbucket = forwardRef<SVGSVGElement, IconProps>(function Bitbucket(props, ref) {
  return (
...
export const CheckCircle = forwardRef<SVGSVGElement, IconProps>(function CheckCircle(props, ref) {
  return (
    <svg
      width="24"
      height="24"
...
export const Git = forwardRef<SVGSVGElement, IconProps>(function Git(props, ref) {
  return (
...
export const GitHub = forwardRef<SVGSVGElement, IconProps>(function GitHub(props, ref) {
  return (
...
export const GitLab = forwardRef<SVGSVGElement, IconProps>(function GitLab(props, ref) {
  return (
...
export const Search = forwardRef<SVGSVGElement, IconProps>(function Search(props, ref) {
  return (
    <svg
      width="24"
      height="24"
...
export const X = forwardRef<SVGSVGElement, IconProps>(function X(props, ref) {
  return (
    <svg
      width="24"
      height="24"
...
export const Code = forwardRef<SVGSVGElement, IconProps>(function Code(props, ref) {
  return (
    <svg
      width="24"
      height="24"
